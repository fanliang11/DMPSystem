...
namespace DMPSystem.Core.EventBus.HashAlgorithms
{
    ...
    public class ConsistentHash<T>
    {
        ...
        private readonly SortedDictionary<int, T> _servers = new SortedDictionary<int, T>();
        ...
        private void AddNode(T node)
        {
            ...
            _servers.Add(_hashAlgorithm.Hash(node.GetHashCode().ToString(CultureInfo.InvariantCulture)),node);
        }
        ...
        private void RemoveNode(T node)
        {
            ...
            _servers.Remove(_hashAlgorithm.Hash(node.GetHashCode().ToString()));
        }
