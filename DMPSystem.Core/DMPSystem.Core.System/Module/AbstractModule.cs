...
namespace DMPSystem.Core.System.Module
{
    ...
    public abstract class AbstractModule : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            {
                base.Load(builder);
                var builderWrapper = new ContainerBuilderWrapper(builder);
                RegisterBuilder(builderWrapper);
                RegisterComponents(builderWrapper);
            }
            catch (Exception ex)
            {
                ...
                Components.ForEach(component =>
                {
                    ...
                    switch (component.LifetimeScope)
                    {
                        case LifetimeScope.InstancePerDependency:
                            if (serviceType.IsGenericType || implementType.IsGenericType)
                            {
