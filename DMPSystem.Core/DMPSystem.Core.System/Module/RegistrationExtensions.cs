...
namespace DMPSystem.Core.System.Module
{
   public static class RegistrationExtensions
    {
        ...
        public static IRegistrationBuilder<object[], SimpleActivatorData, SingleRegistrationStyle> RegisterCollection(this ContainerBuilderWrapper builder, string collectionName, Type elementType)
        {
            return builder.ContainerBuilder.RegisterCollection(collectionName, elementType);
        }

        public static IRegistrationBuilder<T[], SimpleActivatorData, SingleRegistrationStyle> RegisterCollection<T>(this ContainerBuilderWrapper builder, string collectionName)
        {
            return builder.ContainerBuilder.RegisterCollection<T>(collectionName);
        }
